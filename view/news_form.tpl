      ...
      <div class="panel-body">
		...
		<div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-date-time<?php echo $language['language_id']; ?>"><span data-toggle="tooltip" title="<?php echo $help_date_time; ?>"><?php echo $entry_date_time; ?></span></label>
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][date_time]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['date_time'] : ''; ?>" placeholder="<?php echo $entry_date_time; ?>" id="input-date_time<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                </div>
                <?php } ?>
