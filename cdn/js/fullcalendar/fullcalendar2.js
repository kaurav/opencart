...
var BasicView = View.extend({
	...
	numberCellHtml: function(cell) {
		...
		return '' +
			'<td class="' + classes.join(' ') + '" data-date="' + date.format() + '"><div class="hdt-delete" id="delete-me"><i class="glyphicon glyphicon-remove" style="color: #2c3e50;"></i></div> <div class="hdt">' +
				date.date() +
			'</div></td>';
	},
