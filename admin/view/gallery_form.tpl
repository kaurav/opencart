        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-gallery" class="form-horizontal">
          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="gallery_description[<?php echo $language['language_id']; ?>][tag]" value="<?php echo isset($gallery_description[$language['language_id']]) ? $gallery_description[$language['language_id']]['tag'] : ''; ?>" placeholder="<?php echo $entry_tag; ?>" id="input-tag<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                </div>
                <?php } ?>
            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-gallerycategory"><span data-toggle="tooltip" title="<?php echo $help_gallerycategory; ?>"><?php echo $entry_gallerycategory; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="gallerycategory" value="" placeholder="<?php echo $entry_gallerycategory; ?>" id="input-gallerycategory" class="form-control" />
                  <div id="gallery-gallerycategory" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($gallery_categories as $gallery_category) { ?>
                    <div id="gallery-gallerycategory<?php echo $gallery_category['gallerycategory_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $gallery_category['name']; ?>
                      <input type="hidden" name="gallery_category[]" value="<?php echo $gallery_category['gallerycategory_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="gallery-related" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($gallery_relateds as $gallery_related) { ?>
                    <div id="gallery-related<?php echo $gallery_related['gallery_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $gallery_related['name']; ?>
                      <input type="hidden" name="gallery_related[]" value="<?php echo $gallery_related['gallery_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="gallery-filter" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($gallery_filters as $gallery_filter) { ?>
                    <div id="gallery-filter<?php echo $gallery_filter['filter_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $gallery_filter['name']; ?>
                      <input type="hidden" name="gallery_filter[]" value="<?php echo $gallery_filter['filter_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="well well-sm" style="height: 150px; overflow: auto;">
                    <div class="checkbox">
                      <label>
                        <?php if (in_array(0, $gallery_store)) { ?>
                        <input type="checkbox" name="gallery_store[]" value="0" checked="checked" />
                        <?php echo $text_default; ?>
                        <?php } else { ?>
                        <input type="checkbox" name="gallery_store[]" value="0" />
                        <?php echo $text_default; ?>
                        <?php } ?>
                      </label>
                    </div>
                    ...
                    <div class="checkbox">
                      <label>
                        <?php if (in_array($store['store_id'], $gallery_store)) { ?>
                        <input type="checkbox" name="gallery_store[]" value="<?php echo $store['store_id']; ?>" checked="checked" />
                        <?php echo $store['name']; ?>
                        <?php } else { ?>
                        <input type="checkbox" name="gallery_store[]" value="<?php echo $store['store_id']; ?>" />
                        <?php echo $store['name']; ?>
                        <?php } ?>
                      </label>
                    </div>
...
// gallerycategory
$('input[name=\'gallerycategory\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/gallerycategory/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
						label: item['name'],
						value: item['gallerycategory_id']
					}
				}));
			}
		});
	...
	'select': function(item) {
		$('input[name=\'gallerycategory\']').val('');

		$('#gallery-gallerycategory' + item['value']).remove();

		$('#gallery-gallerycategory').append('<div id="gallery-gallerycategory' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="gallery_category[]" value="' + item['value'] + '" /></div>');
	}
});

$('#gallery-gallerycategory').delegate('.fa-minus-circle', 'click', function() {
	$(this).parent().remove();
});
// Filter
$('input[name=\'filter\']').autocomplete({
  ...
  'select': function(item) {
    ...
    $('#gallery-filter' + item['value']).remove();

    $('#gallery-filter').append('<div id="gallery-filter' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="gallery_filter[]" value="' + item['value'] + '" /></div>');
  }
});
$('#gallery-filter').delegate('.fa-minus-circle', 'click', function() {
  $(this).parent().remove();
});
...
$('input[name=\'related\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#gallery-related' + item['value']).remove();

		$('#gallery-related').append('<div id="gallery-related' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="gallery_related[]" value="' + item['value'] + '" /></div>');
	}
});

$('#gallery-related').delegate('.fa-minus-circle', 'click', function() {
	$(this).parent().remove();
});
//--></script>
