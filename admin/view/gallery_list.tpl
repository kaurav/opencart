              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($gallery['gallery_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-center"><?php if ($gallery['image']) { ?>
                    <img src="<?php echo $gallery['image']; ?>" alt="<?php echo $gallery['name']; ?>" class="img-thumbnail" />
                    <?php } else { ?>
...
$('#button-filter').on('click', function() {
	var url = 'index.php?route=catalog/gallery&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/gallery/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
